...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    public: {
      supabaseUrl: process.env.NUXT_PUBLIC_SUPABASE_URL ?? env.NUXT_PUBLIC_SUPABASE_URL ?? '',
      supabaseAnonKey: process.env.NUXT_PUBLIC_SUPABASE_ANON_KEY ?? env.NUXT_PUBLIC_SUPABASE_ANON_KEY ?? '',
    },
  },
